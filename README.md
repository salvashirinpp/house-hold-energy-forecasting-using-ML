...
- All code is in a single file (`forecast_energy.ipynb`) - no custom modules required
- The Flask app requires the model files generated by `forecast_energy.ipynb`
...
- Make sure you've run `forecast_energy.ipynb` first to generate model files
...
<img width="1786" height="972" alt="image" src="https://github.com/user-attachments/assets/aa337a7a-290d-40ee-ade7-1551116df9f8" />
